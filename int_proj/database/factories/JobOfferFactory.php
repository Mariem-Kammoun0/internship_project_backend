...
class JobOfferFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'employment_type' => $this->faker->randomElement(['full-time', 'part-time', 'contract','temporary', 'undefined']),
            'type_of_contract' => $this->faker->randomElement(['permanent', 'fixed-term', 'freelance', 'undefined']),
