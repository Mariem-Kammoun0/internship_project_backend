...
function EmployeeProfile() {
    ...
    const navigationItems = [
        ...
        { id: 'applications', label: 'Candidatures', icon: Briefcase, color: 'bg-green-500' },
                ...
                <div className="space-y-3">
                    <div className="flex items-center justify-between py-3 border-b">
                        <div className="flex items-center space-x-3">
                            ...
                            <div>
                                <p className="font-medium">Nouvelle candidature envoyée</p>
                        ...
                        <div className="flex items-start justify-between">
                            <div className="flex-1">
                                <div className="flex items-center space-x-3 mb-2">
                                    <h4 className="font-semibold text-lg">{application.job_offer.title}</h4>
                                    <span className={getStatusBadge(application.status)}>
                                        {application.status}
                                    </span>
                                </div>
                                <p className="text-gray-600 font-medium mb-2">{application.job_offer.company.name}</p>
